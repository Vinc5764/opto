...
const FlexibleAppointmentSection = () => {
  return (
    <div className="relative w-11/12 h-[70vh] m-auto rounded-xl bg-gray-900 text-white overflow-hidden">
      ...
      {/* Content Container */}
      <div className="relative z-10 max-w-4xl mx-auto h-full flex flex-col justify-center px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap gap-4 items-center">
          <button className="bg-[#36accb] hover:bg-[#36accb] text-white font-bold py-3 px-6 rounded-lg transition duration-300">
            Get Consultation
          </button>
