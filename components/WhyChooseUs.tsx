...
const WhyChooseUs = () => {
  return (
    <section className=" py-16 px-5 mx-4">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        {/* Left Content */}
        <div>
          <h3 className="text-[#36accb] text-lg font-semibold">Why Choose Us</h3>
          <h1 className="text-4xl font-bold text-[#36accb] mt-2">Why We&apos;re Your Best Choice</h1>
          ...
          <div className="mt-8 space-y-4">
            {/* Card 1 */}
            <div className="bg-[#caf4ff] rounded-lg p-4">
              <h3 className="text-lg font-bold text-[#36accb]">Advanced Technology</h3>
            ...
            {/* Card 3 */}
            <div className="bg-[#c5f1fc] rounded-lg p-4">
              <h3 className="text-lg font-bold text-[#36accb]">Personalized Care</h3>
